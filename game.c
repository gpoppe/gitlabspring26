		...
		mnFun();
                ...
                else if(roomChoice == 2)
                {
                        ...
                        if(answer == 1)
                        {
                                ...
                                if(randomNumber == 1)
                                {
                                        puts("The book has a picture of a kid playing Luigi Mansion Dark Moon  on his 3ds!!");
                                }
                                else
                                {
...
void mnFun(void)
{
puts("A white ghost with a crown on its head passes by you and laughs");
}
